...
// Ensure the user is logged in as an HOD
if (!isset($_SESSION['user']) || $_SESSION['user']['role'] !== 'hod') {
    echo json_encode(['success' => false, 'message' => 'Unauthorized access.']);
    exit;
}

$user_id = $_SESSION['user']['user_id']; // Logged-in HOD's user_id
...
try {
    // Fetch faculties (role = 6) of the HOD's department
    $stmt = $conn->prepare("
    ...
    echo json_encode(['success' => false, 'message' => 'Error fetching faculties.', 'error' => $e->getMessage()]);
}
?>
=======
<?php
