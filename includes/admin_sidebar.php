          ...
          <li class="nav-item">
            ...
            <div class="collapse" id="ui-basic">
              <ul class="nav flex-column sub-menu">
                ...
                <li class="nav-item"> <a class="nav-link" href="user_roles.php">User Roles</a></li>
                <li class="nav-item"> <a class="nav-link" href="assign_class_teacher.php">Assign Class Teacher</a></li>
                <li class="nav-item"> <a class="nav-link" href="assign_hod.php">Assign HOD</a></li>
              </ul>
            </div>
          </li>
          <li class="nav-item">
          ...
          <li class="nav-item">
            ...
            <div class="collapse" id="attendance">
              <ul class="nav flex-column sub-menu">
                ...
                <li class="nav-item"> <a class="nav-link" href="user_attendance.php">Faculty/Staff</a></li>
              </ul>
            </div>
          </li>
          <!-- <li class="nav-item">
